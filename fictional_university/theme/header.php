...
<!-- Lisab veebilehe kasutajakeeleks wordpressile m22ratud keele (otsingumootorite tarbeks) -->
    <head>
        <meta charset="<?php bloginfo('charset'); ?>">
        <!-- Kehtib veebilehe sisu kirjakeelele -->
        <meta name="viewport" content="width=device-width, initial-scale=1">
        <!-- Utleb, et erinevad vidinad enda ekraanilaiust usaldaksid -->
        <?php wp_head(); ?>
        <!-- Annab wordpressile loa head sectionit kontrollida -->
    </head>
    <body <?php body_class(); ?>>
    <!-- Annab lehtede bodyle klassid vastavalt nende olemusele (hea css-i ja js-i hiljemaks kasutamiseks) -->
            ...
            <div class="site-header__menu group">
                <nav class="main-navigation">
                    <ul>
                        ...
                        <!-- muudab antud lingi v2rvi, kui oled selle lingi lehel v6i parent lehel -->
                        ...
                        <!-- get_post_type()- m22rab lehe tyybi (post, page etc.) -->
